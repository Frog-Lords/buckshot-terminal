...
int useItem(Player& target, int indexChoice, unsigned int& modifier, std::stack<int> shotgun, bool& isSkipped); //inventory [index] gives corresponding item provides prompt are you sure yes/no
